...
public interface EmployeeDAO {
	...
	boolean updateEmployeeSalaryByIdUsingMerge(int id, int newSalary) throws ClassNotFoundException, SQLException;
	void getEmployeeUsingRefresh(int id) throws ClassNotFoundException, SQLException;
	void usingCriteriaBuilder();
}
